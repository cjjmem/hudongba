...
<!-- saved from url=(0069)http://www.hdb.com/post/article?tempId=105&sceneId=6&hdb_from=WapPost -->
...
<script src="/Public/js/hm(1).js"></script>
<script src="/Public/js/jquery-1.7.2.min.js"></script>
<script>
var _pub_client = "mobile_android";
...
<body>
<div class="outSide" id="post_form" style="min-height: 773px;">
  <!--文章标题 start-->
  <div class="post_title" id="post_article_title_div">
    <span class="post_title_span">文章标题：</span>
    <p class="post_title_p"><input name="" type="text" onblur="_postTemp._set(&#39;post_article_title&#39;,$(this).val())" class="post_title_input" id="post_article_title"></p>
  </div>
  <!--文章标题 end-->
  
  <!--文章详情-->
  <!--文章详情 start-->
  <div class="ke_container" id="ke_article_container_div">
    <div class="ke_edit_top">文章详情</div>
    <div class="ke_edit"><textarea hidefocus="true" class="ke_edit_textarea" onblur="_postTemp._set(&#39;post_article_content&#39;,$(this).val())" id="post_article_content"></textarea></div>
  </div>
  <!--文章详情 end-->
  
  <!--允许推荐-->
  <div ontouchstart="" onclick="_checkbox._check(&#39;post_article_private&#39;)" class="form_checkbox">
    <div class="form_checkbox_text">允许互动吧推荐</div>
    <div class="form_checkbox_check">
      <img id="post_article_private" src="/Public/images/checkbox2x.png">
    </div>
  </div>
...
<div class="post_agreement"><p class="post_agreement_p">我同意<a href="http://www.hdb.com/app/service_duty" class="post_agreement_A" ontouchstart="">《互动吧服务协议》</a></p></div>
  ...
  <!--发布按钮 start-->
  <div class="post_btn"><a href="javascript:void(0);" class="post_btn_A" onclick="_articlePostMB._post()" ontouchstart="">发布</a></div>
  <!--发布按钮 end-->
</div>

<div id="post_article_title_t" style="display:none;"></div>
<div id="post_article_content_t" style="display:none;"></div>
...
var _post = {
  ...
  _isPrivate : "",
  _pageTitle : "",
  _shareTitle : "发表长篇文章，快速召集好友来评论，互动吧-最大的活动发布平台",
};
</script>
